...
class PHP_CRUD_API {
	...
	protected function applyAuthenticationValidator($callback) {
		$errors = array();
	...
	protected function getParameters($settings) {
		...
		if ($authentication_validator) $this->applyAuthenticationValidator($authentication_validator);
	...
	public function __construct($config) {
		...
		$authentication_validator = isset($authentication_validator)?$authentication_validator:null;
		...
		$this->db = $db;
		$this->settings = compact('method', 'request', 'get', 'post', 'database', 'table_authorizer', 'record_filter', 'column_authorizer', 'tenancy_function', 'input_sanitizer', 'input_validator','authentication_validator');
	}
